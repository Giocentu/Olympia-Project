        ...
        <div className="min-h-screen bg-gray-100 font-sans p-4">
            <main className="max-w-7xl mx-auto mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    {/* Tarjeta 1: Torneo - ACTUALIZADA A /admin/nuevo-torneo */}
                    ...
                    {/* Tarjeta 2: Jugador - ACTUALIZADA A /admin/nuevo-jugador */}
                    ...
                    {/* Tarjeta 3: Equipo - ACTUALIZADA A /admin/nuevo-equipo */}
                    ...
                    {/* Tarjeta 4: Personal - ACTUALIZADA A /admin/nuevo-colaborador */}
                    <div className="bg-white rounded-lg shadow-md p-6 border-t-4 border-orange-500 flex flex-col justify-between">
                        ...
                        <Link to="/admin/nuevo-colaborador">

...
(
  ...
  CONSTRAINT chk_formato_torneo CHECK (formato_torneo IN ('Liga', 'Eliminatoria', 'Grupos')),
...
(
  ...
  -- Aseguramos que compartan el mismo vocabulario que Torneo
...
(
  ...
  FOREIGN KEY (dni_usuario) REFERENCES Usuario(dni_usuario),
  -- Validamos los roles dentro del equipo
